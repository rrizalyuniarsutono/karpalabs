    ...
    <body id="page-top">
      <div id="wrapper">
        ...
        <div className="d-flex flex-column">
          <div id="content">
            <div className={`container ${style.mode} ${isDarkMode ? style.dark : ""}`}>
              ...
              <div className="row">
                <div className={`${style.mode} ${isDarkMode ? style.dark : ""}`}>
